      ...
      if($email==$_SESSION['email']){
        ...
        if(mysqli_num_rows($result) == 0) {
          ...
          if(!$edit1){
            ...
            header("Refresh:7; URL=login_cicerone.php");
 ...
 <nav class="navbar navbar-expand-lg navbar-light bg-trasparent" >
  ...
  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
   ...
   <ul class="nav nav-tabs">
    <li class="nav-item">
      <a class="nav-link active" href="/view_profile_cicerone.php?email"> <b> Profilo </b>
       <img src="assets/immagini/cicerone.png" alt="Profilo Cicerone" height=30px width=30px/> </a>
    </li>
    <li class="nav-item">
      <a class="nav-link active" href="/new_attivita.php?email" style="color:#a9a9a9;"> <b> Aggiungi Attività </b></a>
    </li>
    <li class="nav-item">
      <a class="nav-link active" href="/list_attivita_cicerone.php?email" style="color:#a9a9a9;"> <b> Le mie Attività </b></a>
    </li>
    <li class="nav-item">
       <a class="nav-link active" href="/list_richieste_cicerone.php?email" style="color:#a9a9a9;"> <b> Richieste ricevute </b> </a>
    </li>
    <li class="nav-item">
      <a class="nav-link active" href="/logout.php?logout"  style="font-weight:bold;">Logout</a>
    </li>
  </ul>
 </nav>
 </header>
     ...
     <div class="col-md-6 offset-md-3">
      <form class="custom-form" method="post" style="background-color:#eef4f7;" action="<?php echo $_SERVER['PHP_SELF'];?>">
       ...
       <div class="back" style="margin-top:20px;">
        <?php echo "<a href=\"view_profile_cicerone.php?email='.$email.'\" >Indietro</a>";?>
       </div>
      </form>
     </div>
    </div>
