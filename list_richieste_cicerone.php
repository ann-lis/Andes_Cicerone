   ...
   <header>
    <nav class="navbar navbar-expand-lg navbar-light bg-trasparent" >
     ...
     <b>CICERONE</b> <img class="retina" src="assets/immagini/logoCicerone.jpg" alt="Cicerone"/> </a></h2>
      ...
      <li class="nav-item">
       <?php echo" <a class=\"nav-link active\" href=\"/list_richieste_cicerone.php?email='$emailC'\"> <b> Richieste ricevute </b> </a>";?>
      </li>
      <li class="nav-item">
   ...
   <div class="features-boxed">
    <div class="container">
      <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
        <div class="intro">
         <h2 class="text-center" style="color:#000000;font-size:18pt;font-family:lucida fax;font-weight:bold;">
          Richieste di prenotazione ricevute<br><br></h2>
        </div>
        ...
        <div class="container">
          <?php
            ...
            $strSQL = "SELECT *
                       ...
                       ON globetrotter.Email = prenotazione.GlobetrotterEmail) INNER JOIN attivita
                       ON prenotazione.AttivitaID = attivita.ID)
                       WHERE CiceroneEmail = '$emailC'
                       GROUP BY prenotazione.AttivitaId";

            $risultato = mysqli_query($conn,$strSQL);

            //verifica esecuzione query
            //if($risultato === false) {
            ...
            if($valori>0) {
              ...
              echo "<div class=\"table-responsive\" style = \"text-align:center;\">";
                ...
                while($riga = mysqli_fetch_assoc($risultato)) {
                  ...
                  echo "<tr>";
                    echo "<td>".$riga['AttivitaId']."</td>";
                    echo "<td>".$riga['NomeAttivita']."</td>";
                    echo "<td>".$riga['GlobetrotterEmail']."</td>";
                    echo "<td>".$riga['Conferma']."</td>";
                  echo "</tr>";
                }
                echo "</tbody>";
              echo "</table>";
            ...
            echo "<br><div style = \"text-align:center;margin-top:100px;font-weight:bold;font-family:Lucida Fax;font-size:15px;color:#00008B;\">
                  Non hai ricevuto alcuna richiesta di prenotazione.</div>";
          }
