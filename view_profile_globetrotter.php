   ...
   <div style="text-align:center;">
    ...
    <div class="row register-form" style = "background-color:#ffffff;">
      <div class="col-md-6 offset-md-3 " >
        <form class="custom-form" name="form" method="post" style="background-color:#eef4f7;font-family:bookman old style;font-size:12pt;" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>">
          ...
          <div class="form-row form-group " style="height:40px;text-align:left;">
            <div class="form-group col-md-12 " style="margin-left:100px;">
              <label class="col-form-label" for="name-input-field">Cognome:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $cognome; ?></label>
            </div>
          </div>

          <div class="form-row form-group " style="height:40px;text-align:left;">
            <div class="form-group col-md-12"style="margin-left:100px;">
              <label class="col-form-label" for="name-input-field">Nome:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $nome; ?></label>
            </div>
          </div>

          <div class="form-row form-group " style="height:40px;text-align:left;">
            <div class="form-group col-md-12 "style="margin-left:100px;">
              <label class="col-form-label" for="name-input-field">Telefono:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $telefono; ?></label>
            </div>
          </div>

          <div class="form-row form-group " style="height:40px;text-align:left;">
            <div class="form-group col-md-12 "style="margin-left:100px;">
              <label class="col-form-label" for="name-input-field">Email:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $email; ?></label>
            </div>
          </div>

          <div class="form-row form-group " style="height:40px;text-align:left;">
            <div class="form-group col-md-12 " style="margin-left:100px;">
              <label class="col-form-label" for="name-input-field">Password:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
               <input class="col-form-input" type="password" name="password" readonly="readonly" style="background-color:#eef4f7;border-style:none" value="<?php echo substr($password,0,8); ?>">
              </label>
            </div>
          </div>
          <br><br>
          ...
          <div class="form-row form-group " style="height:40px;">
            <div class="form-group col-md-6 offset-md-1">
              <button class="btn btn-primary btn-sm" type="button" 
                      onclick="location.href='edit_profile_globetrotter.php?email'">
                      <b> AGGIORNA </b></button>
            </div>
   ...
   <script type="text/javascript">
     function confirm_delete() {
       if(confirm("Sei sicuro di voler cancellare il tuo account?") == true) {
         location.href='delete_profile_globetrotter.php';
       }else{
